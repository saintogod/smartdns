...
| response-mode | 结果回应模式 | fastest-ip | [fastest-ip\|whole-response] | response-mode whole-response|
...
| serve-expired-reply-ttl | 回应的过期缓存 TTL | 5 | 秒，过期缓存被查询到时，回应的 TTL 值 | serve-expired-reply-ttl 30 |
