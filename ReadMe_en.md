...
|response-mode|response mode|fastest-ip|[fastest-ip\|whole-response]|response-mode whole-response
...
|serve-expired-reply-ttl|TTL value to use when replying with expired data|5|second，TTL value of reply|serve-expired-reply-ttl 30
